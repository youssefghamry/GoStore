...
?>
	<div class="ts-blogs ts-shortcode related-posts related ts-slider <?php echo esc_attr($is_slider?'loading':''); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related Posts', 'gostore'); ?></h3>
		</header>
						...
						<div class="entry-content <?php echo !$show_thumbnail?'no-featured-image':'' ?>">
							...
							<header>
								...
								<div class="entry-meta-top">
									...
									<!-- Blog Comment -->
									<?php if( function_exists('gostore_get_post_comment_count') ): ?>
							...
							<div class="excerpt"><?php gostore_the_excerpt_max_words(14, '', true, '', true); ?></div>
